...
import com.zhxh.corelibs.utils.LogUtils;
...
public abstract class BaseLazyFragment extends BaseFragment {
    ...
    private FrameLayout realLayoutContainer = null;
    /**
     * 是否延迟 inflate View 如果设置为true 将在 该fragment 第一次对用户可见的时候inflate布局，可以进一步优化多page页面 进入速度。
     * 默认不开启。需要开启的话 使用  setInflateLazy(true) 开启
     */
    private boolean inflateLazy = false;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(inflateLazy) {
            realLayoutContainer = new FrameLayout(mActivity);
            return realLayoutContainer;
        }
    ...
    /**
     * 是否开启 延迟 infalte view 方案
     * @param inflateLazy true 延迟初始化
     */
    public void setInflateLazy(boolean inflateLazy) {
        this.inflateLazy = inflateLazy;
    }
}